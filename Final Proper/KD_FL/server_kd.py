...
test_dir1 = r"D:\Major Project\Final Proper\3class_test"
...
def server_socket():
    ...
    model_student.save(r"D:\Major Project\Final Proper\Models\drowsiness_model_Pre_distlled_unbalanced.keras")
    ...
    # Train model
    distiller.fit(train_gen, validation_data=val_gen, epochs=20,verbose=0)
    ...
    evaluate_model_start(distiller.student, test_dir1)
    distiller.student.save(r"D:\Major Project\Final Proper\Models\drowsiness_model_Post_distlled_unbalanced.keras")
    ...
    save_temp_model(distiller.student, student_post_path)
    ...
    student_post_flops = get_flops(distiller.student)
    ...
    global_model = distiller.student
    ...
    #     evaluate_model(global_model, r"D:\Major Project\Final Proper\3class_test",round_num)  # Removed directory loading
